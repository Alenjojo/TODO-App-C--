#Hi, i had a alot of trouble fixing the app. Firstly it wasn't able to run in windows properly.It took alot of time to fix it.Still it produces error but it will work fine in linux
#Thank You
